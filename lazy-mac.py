...
commands.add_argument('-sleep','--sleep', metavar = '', type=int, help='Sleep shutdown in number of minutes')
...
def lockScreen():
    ...
    os.system("osascript -e 'quit app (path to frontmost application as text)'")
